...
@section('title','الطلبات التي لم تتحقق من الجوال')
@section('breadcrumb','الطلبات التي لم تتحقق من الجوال')
      ...
      <div class="portlet light bordered">
        <div class="portlet-title">
          <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">بيانات الطلبات التي لم تتحقق من الجوال</span>
          </div>
          <div class="tools"> </div>
        </div>
